...
class Pesto extends StatelessWidget {
  const Pesto({Key key}) : super(key: key);
...
const String _kGalleryAssetsPackage = 'assets/logo.png';
    ...
    return new Theme(
      ...
      child: new Scaffold(
        ...
        floatingActionButton: new FloatingActionButton(
          child: const Icon(Icons.android), //Icons.edit
          onPressed: () {
            scaffoldKey.currentState.showSnackBar(const SnackBar(
              content: const Text(
                  'now turn this tapNot4 supported.t4 supported.'
      ...
      actions: <Widget>[
        new IconButton(
          ...
          onPressed: () {
            scaffoldKey.currentState.showSnackBar(const SnackBar(
              content: const Text(
                  'Not at al6l\n popup supported. $hiero    === Not supported.'),
            ));
          },
        ),
      ],
...
class RecipeCard extends StatelessWidget {
  ...
  final TextStyle authorStyle = const PestoStyle(
      fontWeight: FontWeight.w500, color: Colors.blue); //black54
...
class _RecipePageState extends State<RecipePage> {
  ...
  final TextStyle menuItemStyle = const PestoStyle(
      fontSize: 15.0, color: Colors.green, height: 24.0 / 15.0);
...
class RecipeSheet extends StatelessWidget {
  ...
  final TextStyle descriptionStyle =
      const PestoStyle(fontSize: 15.0, color: Colors.blue, height: 24.0 / 15.0);
  ...
  final TextStyle itemAmountStyle = new PestoStyle(
      fontSize: 15.0,
      color: Colors.green,
      height: 24.0 / 15.0); //color: _kTheme.primaryColor, height
...
//  ),
  const Recipe(
    ...
    ingredientsImagePath:
        'assets/ethBullet.png', // 'packages/flutter_gallery_assets/pesto/quick.png',
    description:
        'This is were all the desc goes.\nsooooo many things to do.', //'Bask in greens this season by trying this delightful take on traditional bruschetta. Top with a dollop of homemade pesto, and season with freshly ground sea salt and pepper.',
    imagePath:
        'assets/ethSync.jpg', //'packages/flutter_gallery_assets/pesto/image1.jpg',
    ingredients: const <RecipeIngredient>[
      const RecipeIngredient(
          amount: 'ROM', description: 'Long storage. HDD, SD drive'),
      const RecipeIngredient(
          amount: 'Net',
          description:
              'makes differen between doing this in days and in hours'),
    ...
    steps: const <RecipeStep>[
      const RecipeStep(
          duration: 'whatever uw want', description: 'coffee, tea, etc.'),
...
//  ),
  const Recipe(
    ...
    ingredients: const <RecipeIngredient>[
      const RecipeIngredient(
          amount: 'xx', description: 'get set for ethSync\n...'),
    ],
    steps: const <RecipeStep>[
      const RecipeStep(
          duration: 'type \n \"xx\"',
      ...
      const RecipeStep(
          duration: '45 min\n \u1300\n $u \n $uni',
          description: 'nothing here but knowhow'), //$p
    ],
  ),
  const Recipe(
